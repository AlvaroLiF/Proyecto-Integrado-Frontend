...
const routes: Routes = [
  ...
  { path: 'admin-home/product-management', component: ProductManagementComponent, canActivate: [AdminGuard] },
  ...
  { path: 'user/addresses', component: AddressesComponent, canActivate: [AuthGuard] },
